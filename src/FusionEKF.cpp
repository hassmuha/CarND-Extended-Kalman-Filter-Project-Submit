...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  if (!is_initialized_) {
    ...
    */
    // first measurement
    //cout << "DEBUG0:" << endl;
    //ekf_.x_ = VectorXd(4); //initialize in init
    //ekf_.x_ << 1, 1, 1, 1;
    ...
    if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
      ...
      */
      ...
      //cout << "DEBUG1: Printing the Radar" << endl << ekf_.x_ << endl;
    }
      ...
      */
      ...
      py = measurement_pack.raw_measurements_[1];
		  ekf_.x_ << px, py, 0, 0;
      previous_timestamp_ = measurement_pack.timestamp_;
      //cout << "DEBUG1: Printing the Lidar" << endl << ekf_.x_ << endl;
   ...
   */
   ...
   //cout << "DEBUG4: 2nd Measurement Before Predict" << endl;
